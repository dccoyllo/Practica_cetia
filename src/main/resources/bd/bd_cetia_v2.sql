...
INSERT INTO `bd_cetia_v2`.`publicacion` (`idpublicacion`, `titulo`, `fecha`, `hora`, `descripcion`, `imagen`, `idtipopublicacion`, `idusuario`) VALUES ('1', 'Programa Vose', '20-11-14', '20:42', 'Pues ésta es tu oportunidad para que puedas pertenecer al programa VOSE (Voluntarios al Servicio).', '/img/publicacion/vose.png', '5', '1');
INSERT INTO `bd_cetia_v2`.`publicacion` (`idpublicacion`, `titulo`, `fecha`, `hora`, `descripcion`, `imagen`, `idtipopublicacion`, `idusuario`) VALUES ('2', 'Voluntariado en Psicología', '2020-11-13', '15:24', 'trabaja con nosotros, unete y ayuda', '/img/publicacion/voluntariadoenpsicologia.jpg', '4', '2');
INSERT INTO `bd_cetia_v2`.`publicacion` (`idpublicacion`, `titulo`, `fecha`, `hora`, `descripcion`, `imagen`, `idtipopublicacion`, `idusuario`) VALUES ('3', 'Día Mundial de las Habilidades de la Juventud', '2020-11-02', '9:52', 'La resolución expresa preocupación por el elevado número de jóvenes desempleados y reconoce que el fomento de la adquisición de habilidades por los jóvenes mejoraría su capacidad de tomar decisiones con conocimiento de causa en relación con la vida y el trabajo y los empoderaría de manera que puedan acceder al mercado laboral en evolución.', '/img/publicacion/diadelajuventud_n.png', '6', '2');
INSERT INTO `bd_cetia_v2`.`publicacion` (`idpublicacion`, `titulo`, `fecha`, `hora`, `descripcion`, `imagen`, `idtipopublicacion`, `idusuario`) VALUES ('4', 'Dia Mundial del agua', '2020-03-22', '8:00', 'El agua, elemento necesario para la supervivencia de todo ser vivo. muchas veces la derrochamos y malgastamos con acciones innecesarias. El tomar conciencia es indispensable para poder valorar este recurso que en un momento fue ilimitado, pero con el transcurrir de los años junto con la conducta del ser humano, este recurso se fue limitando.', '/img/publicacion/diamundialdelagua.png', '6', '2');
INSERT INTO `bd_cetia_v2`.`publicacion` (`idpublicacion`, `titulo`, `fecha`, `hora`, `descripcion`, `imagen`, `idtipopublicacion`, `idusuario`) VALUES ('5', 'Dia internacional de la Mujer ', '2020-03-08', '8:00', '\"Para una mujer con grandes sueños ni siquiera el cielo es el límite…esa es mi filosofía de vida, y lo más seguro es que fue también la de muchas mujeres en el pasado que se convirtieron en artistas de la transformación y líderes de la revolución, pues supieron proyectar el futuro de un milenio, logrando marcar hitos con grandes actuaciones, haciendo más y observando menos, siendo pioneras y protagonistas de cambios en el mundo".', '/img/publicacion/Felizdiainternacionalde lamujer.png', '6', '2');
